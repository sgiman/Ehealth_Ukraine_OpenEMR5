                            ...
                            <div class="text-center" data-bind="if: $root.show_button()">
                                ...
                                <button type="button" class="btn btn-bright-green mrg10T mrg10B"
                                    ...
                                    Створити
									 ...
									 <p>Для завершення підтвердити реєстрацію працівника за адресою e-mail</p>
...
-->
    ...
    <script type="text/javascript">
		...
		var model = new CreateEmployeeRequestViewModel(org_id,  '',  '');
...
<!--***************************************************** initEmployee *****************************************************-->
   <script type="text/JavaScript">
        $(document).ready(function() {
                model.employee_request().initEmployee('');
        });
    </script>
<!--**************************************************************************************************************************-->
