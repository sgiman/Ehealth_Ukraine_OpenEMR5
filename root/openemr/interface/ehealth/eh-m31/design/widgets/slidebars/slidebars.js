    ...
    $.slidebars = function(options) {
        ...
        function initialise() {
            if (!settings.disableOver || (typeof settings.disableOver === 'number' && settings.disableOver >= windowWidth)) { // False or larger than window size.
                ...
                $module.css('minHeight', ''); // Remove minimum height.
        ...
        function css() {
            // Set minimum height.
            $module.css('minHeight', ''); // Reset minimum height.
            $module.css('minHeight', $('html').height() + 'px'); // Set minimum height of the site to the minimum height of the html.
