...
<div class="modal fade" id="RejectModal" tabindex="-1" data-focus-on="input:first" style="display: none;">
    <div class="modal-header">
        <h4 class="modal-title text-danger">Деактивація підрозділу</h4>
    </div>
    <div class="modal-body">
        <form class="form-horizontal col-sm-12">
            <div class="form-group">
                <div>
                    Чи дійсно ви бажаєте деактивувати підрозділ?
                </div>
            </div>
        </form>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal" data-bind="click: deactiveDivision">Деактивувати</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Відмовитись</button>
    </div>
</div>

<!-- //////////////////////////////////// ActivateModal //////////////////////////////////// -->
<div class="modal fade" id="ActivateModal" tabindex="-1" data-focus-on="input:first" style="display: none;">
    <div class="modal-header">
        <h4 class="modal-title text-danger">Активація підрозділу</h4>
    </div>
    <div class="modal-body">
        <form class="form-horizontal col-sm-12">
            <div class="form-group">
                <div>
                    Чи дійсно ви бажаєте Активувати підрозділ?
                </div>
            </div>
        </form>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal" data-bind="click: activateDivision">Активувати</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Відмовитись</button>
    </div>
</div>
        ...
        <div id="page-title">
            <h2 class="mrg20T mrg20B">
                ...
                <div class="header-buttons ">				
                          <a class="btn size-md btn-success" href="/openemr/interface/ehealth/eh-m31/Division.php?id=<?php echo $_GET['id']; ?>"
										title="Оновити">
										<i class="glyph-icon icon-repeat"></i>
                                 Оновити
								</a> 

                          <a class="btn size-md btn-success" href="ListOfDivisions.php"
                           ...
                           <a id="DeactiveBTN" class="btn size-md btn-danger" href=""
										title="Деактивувати підрозділ"
										data-toggle="modal" 
										data-target="#RejectModal"
										>
										<i class="glyph-icon icon-remove"></i>
										Деактивувати підрозділ
                           </a>

                           <a id="ActiveBTN" class="btn size-md btn-danger" href=""
										title="Активувати підрозділ"
										data-toggle="modal" 
										data-target="#ActivateModal"
										>
										<i class="glyph-icon icon-check"></i>
										Активувати підрозділ
                           </a>
                </div>
            </h2>			
        </div>
                                ...
                                <div class="form-horizontal pad15L pad15R pad20T pad20B justify-content-center">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class = "col-xs-12 col-md-6" >
                                            <input id="division_status" class = "form-control" type = "text" value="NONE"
                                                   data-bind = "value: division().status" disabled />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <select id="type" class="form-control single" 
                                ...
                                <div class="header-buttons">
                                    <a href="#" class="btn size-md btn-success mrg7T" title=""
                                       ...
                                       data-bind="click: division().addLocation,
                                            visible: $root.show_button() && !division().location().latitude">
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="col-md-1 text-right">
                                            <button type="button" class="btn btn-danger"
                                                    tabindex="-1"
                                                    data-bind="click: $parent.division().removeLocation, visible: $root.show_button() && !$parent.division().location().latitude">
                                                <span class="glyph-icon icon-remove"></span>
                                            </button>
                                        </div>
                                    </div>
                                    <!-- /ko -->
                                </div><!-- form-horizontal pad15L pad15R pad20T pad20B justify-content-center -->							
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label col-md-2">
												<span class="text-danger">*&nbsp;</span>Тип телефону</label>
                                        <div class="col-xs-12 col-md-3">
...
<!-- ************************************************************************************* -->																	
            ...
            <div class="text-center">
                <button type="button" class="btn btn-bright-green mrg10T mrg10B" data-bind="click: updateDivision, visible: $root.show_button()">
                    Зберегти підрозділ
                </button>
...
<script src="js/pages/updateDivision.js"></script>
...
<script type="text/javascript">
    ...
    var model = new UpdateDivisionViewModel();
...
<script type="text/JavaScript">
    ...
    $(document).ready(function () {		
		...
		model.getDivisionById(org_id, '<?php echo $_GET["id"]; ?>');		
		
		setTimeout (function () { 
			var status = $("#division_status").val();
			//alert("**** TEST = " + status);
			
			//--- show_deactive_button ---
			if (status === 'ACTIVE') {
				$("#ActiveBTN").hide();
				$("#DeactiveBTN").show();			
			}
