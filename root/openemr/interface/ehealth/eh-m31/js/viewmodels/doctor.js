...
function  DoctorViewModel() {
    ...
    self.educations = ko.observableArray([new DoctorEducationViewModel()]).extend({ required: true });
    self.qualifications = ko.observableArray(); // [new DoctorQualificationViewModel()]
    self.specialities = ko.observableArray([new DoctorSpecialityViewModel()]).extend({ required: true });
    ...
    self.addEducation = function () {
        self.educations.push(new DoctorEducationViewModel());
    };
    ...
    self.addQualification = function () {
        self.qualifications.push(new DoctorQualificationViewModel());
    };
    ...
    self.addSpeciality = function () {
        self.specialities.push(new DoctorSpecialityViewModel());
    };
    ...
    self.addScienceDegree = function () {
        self.science_degree.push(new DoctorScienceDegreeViewModel());
    };
    ...
    self.doctorErrors = ko.validation.group(this);
}
