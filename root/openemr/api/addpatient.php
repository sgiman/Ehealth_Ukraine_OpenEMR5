...
$hipaa_mail = $_GET['hipaa_mail'];
$hipaa_voice = $_GET['hipaa_voice'];
$hipaa_notice = $_GET['hipaa_notice'];
$hipaa_message = $_GET['hipaa_message'];
$hipaa_allowsms = $_GET['hipaa_allowsms'];
$hipaa_allowemail = $_GET['hipaa_allowemail'];

$email_direct = $_GET['email_direct'];
$family_size = $_GET['family_size'];
$monthly_income = $_GET['monthly_income'];

$allow_imm_reg_use = $_GET['allow_imm_reg_use'];
$allow_imm_info_share = $_GET['allow_imm_info_share'];
$allow_health_info_ex = $_GET['allow_health_info_ex'];
$allow_patient_portal = $_GET['allow_patient_portal'];
$cmsportal_login = $_GET['cmsportal_login'];
