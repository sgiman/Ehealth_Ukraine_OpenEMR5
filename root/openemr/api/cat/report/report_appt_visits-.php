...
require_once("includes/../custom/code_types.inc.php");
...
$from_date = fixDate($_GET['from_date'], date('Y-m-d'));
$to_date = fixDate($_GET['to_date'], date('Y-m-d'));
$details = $_GET['details'] ? true : false;
